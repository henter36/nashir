...
| Group 4 role names and privileges | Draft 004 and planning gates | Record migration/application role names; verify `audit_events` owner and application role privileges | YES |
