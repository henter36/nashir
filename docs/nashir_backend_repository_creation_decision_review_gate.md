...
| Contract sync | PENDING | OpenAPI, SQL, or Auth/RBAC drift can produce incompatible backend behavior | YES | YES | YES | Define pinning, drift detection, dependency rules, and failure handling |
