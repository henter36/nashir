...
- `README.md` and `docs/screen_map.md` aligned with the 23-page source of truth.
...
Required verification for `henter36/nashir`:
...
Required verification for `marketing-os`:
...
Required verification for `nashir-backend`:
